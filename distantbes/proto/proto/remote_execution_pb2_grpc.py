...
from distantbes.proto.google.longrunning import operations_pb2 as google_dot_longrunning_dot_operations__pb2
from distantbes.proto.proto import remote_execution_pb2 as proto_dot_remote__execution__pb2
...
class ExecutionStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Execute = channel.unary_stream(
                ...
                request_serializer=proto_dot_remote__execution__pb2.ExecuteRequest.SerializeToString,
                response_deserializer=google_dot_longrunning_dot_operations__pb2.Operation.FromString,
                )
        self.WaitExecution = channel.unary_stream(
                '/build.bazel.remote.execution.v2.Execution/WaitExecution',
                request_serializer=proto_dot_remote__execution__pb2.WaitExecutionRequest.SerializeToString,
                response_deserializer=google_dot_longrunning_dot_operations__pb2.Operation.FromString,
                )
...
def add_ExecutionServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Execute': grpc.unary_stream_rpc_method_handler(
                    servicer.Execute,
                    request_deserializer=proto_dot_remote__execution__pb2.ExecuteRequest.FromString,
                    response_serializer=google_dot_longrunning_dot_operations__pb2.Operation.SerializeToString,
            ),
            'WaitExecution': grpc.unary_stream_rpc_method_handler(
                    servicer.WaitExecution,
                    request_deserializer=proto_dot_remote__execution__pb2.WaitExecutionRequest.FromString,
                    response_serializer=google_dot_longrunning_dot_operations__pb2.Operation.SerializeToString,
            ),
    }
...
class Execution(object):
    ...
    def Execute(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/build.bazel.remote.execution.v2.Execution/Execute',
            proto_dot_remote__execution__pb2.ExecuteRequest.SerializeToString,
    ...
    def WaitExecution(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/build.bazel.remote.execution.v2.Execution/WaitExecution',
            proto_dot_remote__execution__pb2.WaitExecutionRequest.SerializeToString,
            google_dot_longrunning_dot_operations__pb2.Operation.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
...
class ActionCacheStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetActionResult = channel.unary_unary(
                ...
                request_serializer=proto_dot_remote__execution__pb2.GetActionResultRequest.SerializeToString,
                response_deserializer=proto_dot_remote__execution__pb2.ActionResult.FromString,
                )
        self.UpdateActionResult = channel.unary_unary(
                '/build.bazel.remote.execution.v2.ActionCache/UpdateActionResult',
                request_serializer=proto_dot_remote__execution__pb2.UpdateActionResultRequest.SerializeToString,
                response_deserializer=proto_dot_remote__execution__pb2.ActionResult.FromString,
                )
...
def add_ActionCacheServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetActionResult': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=proto_dot_remote__execution__pb2.GetActionResultRequest.FromString,
                    response_serializer=proto_dot_remote__execution__pb2.ActionResult.SerializeToString,
            ),
            'UpdateActionResult': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateActionResult,
                    request_deserializer=proto_dot_remote__execution__pb2.UpdateActionResultRequest.FromString,
                    response_serializer=proto_dot_remote__execution__pb2.ActionResult.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class ActionCache(object):
    ...
    def GetActionResult(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/build.bazel.remote.execution.v2.ActionCache/GetActionResult',
            proto_dot_remote__execution__pb2.GetActionResultRequest.SerializeToString,
            proto_dot_remote__execution__pb2.ActionResult.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UpdateActionResult(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/build.bazel.remote.execution.v2.ActionCache/UpdateActionResult',
            proto_dot_remote__execution__pb2.UpdateActionResultRequest.SerializeToString,
            proto_dot_remote__execution__pb2.ActionResult.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
...
class ContentAddressableStorageStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FindMissingBlobs = channel.unary_unary(
                ...
                request_serializer=proto_dot_remote__execution__pb2.FindMissingBlobsRequest.SerializeToString,
                response_deserializer=proto_dot_remote__execution__pb2.FindMissingBlobsResponse.FromString,
                )
        self.BatchUpdateBlobs = channel.unary_unary(
                '/build.bazel.remote.execution.v2.ContentAddressableStorage/BatchUpdateBlobs',
                request_serializer=proto_dot_remote__execution__pb2.BatchUpdateBlobsRequest.SerializeToString,
                response_deserializer=proto_dot_remote__execution__pb2.BatchUpdateBlobsResponse.FromString,
                )
        self.BatchReadBlobs = channel.unary_unary(
                '/build.bazel.remote.execution.v2.ContentAddressableStorage/BatchReadBlobs',
                request_serializer=proto_dot_remote__execution__pb2.BatchReadBlobsRequest.SerializeToString,
                response_deserializer=proto_dot_remote__execution__pb2.BatchReadBlobsResponse.FromString,
                )
        self.GetTree = channel.unary_stream(
                '/build.bazel.remote.execution.v2.ContentAddressableStorage/GetTree',
                request_serializer=proto_dot_remote__execution__pb2.GetTreeRequest.SerializeToString,
                response_deserializer=proto_dot_remote__execution__pb2.GetTreeResponse.FromString,
                )
...
def add_ContentAddressableStorageServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'FindMissingBlobs': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=proto_dot_remote__execution__pb2.FindMissingBlobsRequest.FromString,
                    response_serializer=proto_dot_remote__execution__pb2.FindMissingBlobsResponse.SerializeToString,
            ),
            'BatchUpdateBlobs': grpc.unary_unary_rpc_method_handler(
                    servicer.BatchUpdateBlobs,
                    request_deserializer=proto_dot_remote__execution__pb2.BatchUpdateBlobsRequest.FromString,
                    response_serializer=proto_dot_remote__execution__pb2.BatchUpdateBlobsResponse.SerializeToString,
            ),
            'BatchReadBlobs': grpc.unary_unary_rpc_method_handler(
                    servicer.BatchReadBlobs,
                    request_deserializer=proto_dot_remote__execution__pb2.BatchReadBlobsRequest.FromString,
                    response_serializer=proto_dot_remote__execution__pb2.BatchReadBlobsResponse.SerializeToString,
            ),
            'GetTree': grpc.unary_stream_rpc_method_handler(
                    servicer.GetTree,
                    request_deserializer=proto_dot_remote__execution__pb2.GetTreeRequest.FromString,
                    response_serializer=proto_dot_remote__execution__pb2.GetTreeResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class ContentAddressableStorage(object):
    ...
    def FindMissingBlobs(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/build.bazel.remote.execution.v2.ContentAddressableStorage/FindMissingBlobs',
            proto_dot_remote__execution__pb2.FindMissingBlobsRequest.SerializeToString,
            proto_dot_remote__execution__pb2.FindMissingBlobsResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def BatchUpdateBlobs(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/build.bazel.remote.execution.v2.ContentAddressableStorage/BatchUpdateBlobs',
            proto_dot_remote__execution__pb2.BatchUpdateBlobsRequest.SerializeToString,
            proto_dot_remote__execution__pb2.BatchUpdateBlobsResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def BatchReadBlobs(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/build.bazel.remote.execution.v2.ContentAddressableStorage/BatchReadBlobs',
            proto_dot_remote__execution__pb2.BatchReadBlobsRequest.SerializeToString,
            proto_dot_remote__execution__pb2.BatchReadBlobsResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetTree(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/build.bazel.remote.execution.v2.ContentAddressableStorage/GetTree',
            proto_dot_remote__execution__pb2.GetTreeRequest.SerializeToString,
            proto_dot_remote__execution__pb2.GetTreeResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
...
class CapabilitiesStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCapabilities = channel.unary_unary(
                ...
                request_serializer=proto_dot_remote__execution__pb2.GetCapabilitiesRequest.SerializeToString,
                response_deserializer=proto_dot_remote__execution__pb2.ServerCapabilities.FromString,
                )
...
def add_CapabilitiesServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetCapabilities': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=proto_dot_remote__execution__pb2.GetCapabilitiesRequest.FromString,
                    response_serializer=proto_dot_remote__execution__pb2.ServerCapabilities.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class Capabilities(object):
    ...
    def GetCapabilities(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/build.bazel.remote.execution.v2.Capabilities/GetCapabilities',
            proto_dot_remote__execution__pb2.GetCapabilitiesRequest.SerializeToString,
            proto_dot_remote__execution__pb2.ServerCapabilities.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
